...
OUTPUT_TWEET_COUNT_PATH_FILE = f"{OUTPUT_TWEET_COUNT_PATH}/{COIN_SHORT_NAME}/{COIN_SHORT_NAME}_current_tweet_count{SUFFIX_FILTERED}{SUFFIX_AUGUST}.json"
OUTPUT_SECOND_CLASSIFIER_Y = f"{OUTPUT_TWEET_COUNT_PATH}/{COIN_SHORT_NAME}/{COIN_SHORT_NAME}_price_diff_original{SUFFIX_FILTERED}{SUFFIX_AUGUST}.npy"
OUTPUT_FIERT_CLASSIFIER_Y = f"{OUTPUT_TWEET_COUNT_PATH}/{COIN_SHORT_NAME}/{COIN_SHORT_NAME}_price_diff{SUFFIX_FILTERED}{SUFFIX_AUGUST}.npy"
OUTPUT_SECOND_CLASSIFIER_X = f"{OUTPUT_TWEET_COUNT_PATH}/{COIN_SHORT_NAME}/{COIN_SHORT_NAME}_price_diff_past{SHIFT}days{SUFFIX_FILTERED}{SUFFIX_AUGUST}.npy"
